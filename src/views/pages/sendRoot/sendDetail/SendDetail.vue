<template>
  <el-main>
    ...
    <el-table :height="tableHeigth" :data="tableList.list" border stripe>
      ...
      <el-table-column prop="province" label="省份" min-width="130" show-overflow-tooltip></el-table-column>
      ...
      <el-table-column prop="type" label="领取类型" align="center" width="90">
        <template #default="scope">
          <el-tag v-if="scope.row.type == '1'" type="danger">政府</el-tag>
          ...
          >
          <el-tag v-if="scope.row.type == '4'" type="info" size="default"
          >个人
          </el-tag
          >
      ...
      <el-table-column prop="doType" label="紧急程度" align="center" width="90">
        <template #default="scope">
          <el-tag v-if="scope.row.doType == '1'" type="info" size="default">不急</el-tag>
          <el-tag v-if="scope.row.doType == '2'" type="warning" size="default"
          >紧急
          </el-tag
          >
          <el-tag v-if="scope.row.doType == '3'" type="danger" size="default"
          >特急
          </el-tag
          >
      ...
      <el-table-column prop="status" label="审核状态" align="center" width="100">
        <template #default="scope">
          ...
          <el-tag v-if="scope.row.status == '2'" type="danger" size="default">拒绝发放</el-tag>
        </template>
      </el-table-column>
...
import useDetailTable from "@/composables/sendRoot/sendDetail/useDetailTable";
